...
export function textAppointmentSubmitted(a: AppointmentInfo) {
...
export function textQueueJoined(q: QueueInfo) {
  return `Hi ${q.customerName}! You're #${q.position} in line for ${q.serviceName}. We'll message you when it's your turn! - ${SALON_NAME}`;
}

export function textQueueCalled(q: QueueInfo) {
